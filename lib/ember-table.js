...
Ember.TEMPLATES["components/_ember-table"] = Ember.Handlebars.template(function anonymous(Handlebars,depth0,helpers,partials,data) {
this.compilerInfo = [4,'>= 1.0.0'];
helpers = this.merge(helpers, Ember.Handlebars.helpers); data = data || {};
...
Ember.Table.EmberTableComponent = Ember.Component.extend(Ember.StyleBindingsMixin, Ember.ResizeHandler, {
  ...
  forceFillColumns: function() {
    ...
    defaultContentWidth = this._getTotalWidth(tableColumns);
